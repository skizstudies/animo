  ...
  return (
    <div className="flex flex-[1.3] flex-col items-center justify-center gap-4 rounded-[6px] border-2 border-dashed border-border bg-card px-8 text-center">
      ...
      <div>
        ...
        <h3 className="mt-1 text-[17px] font-extrabold text-ink">Integrating from the GIS workstream</h3>
        <p className="mx-auto mt-1 max-w-[36ch] text-[14.5px] text-ink-soft">
          {selectedFarm
